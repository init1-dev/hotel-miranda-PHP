<header id="header" class="header">
    ...
    <nav id="navbar" class="header__nav">
        ...
        <div class="nav__logo--container">
            <a class="nav__logo--container--a" href="index.php">
        ...
        <ul class="header__nav--list">
            <li class="header__nav--item">
                <a class="header__nav-link" href="about.php">Abous Us</a>
            </li>
            <li class="header__nav--item">
                <a class="header__nav-link" href="rooms-grid.php">Rooms</a>
            </li>
            <li class="header__nav--item">
                <a class="header__nav-link" href="offers.php">Offers</a>
            </li>
            <li class="header__nav--item">
                <a class="header__nav-link" href="contact.php">Contact</a>
            </li>
        </ul>
